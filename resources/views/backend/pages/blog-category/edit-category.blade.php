                ...
                <div class="card">
                    <div class="card-body">
                        <div class=" d-flex justify-content-between align-items-center">
                            <h3 class="text-dark fw-bold lead d-inline">Edit blog category</h3>
                            <a href="{{ route('blog-category.index') }}" class=" btn btn-dark btn-sm">All blog
                                Category</a>
                        </div>

                        <hr class=" text-info">
                        <form action="{{ route('blog-category.update', $category->id) }}" method="post" id="myForm">
                            @csrf
                            @method('put')
