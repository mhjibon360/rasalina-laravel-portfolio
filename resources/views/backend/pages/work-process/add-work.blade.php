...
@section('title', 'add new working-process')
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class=" d-flex justify-content-between align-items-center">
                            <h3 class="text-dark fw-bold lead d-inline">Create New working-process</h3>
                        ...
                        <form action="{{ route('working.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="my-3 form-group">
                                ...
                                <input class="form-control" type="text" placeholder="working-process small title"
                                    id="small_title" name="small_title" value="" required>
                            </div>
                            ...
                            <div class="my-3 form-group">
                                ...
                                <textarea name="details" id="elm1" rows="4" class=" form-control"
                                    placeholder="write your working-process details..."></textarea>
                            </div>
