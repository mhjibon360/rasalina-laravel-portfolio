...
@section('title', 'home about show all multi image')
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="text-dark fw-bold lead ">Home About Display Multi Image</h3>
                            <<a href="{{ route('multiimage.create') }}"
                            ...
                            <tbody>
                                @foreach ($allmulitImage as $item)
                                    <tr>
                                        ...
                                        <td style="width:20%">
                                            <a href="{{ route('multiimage.edit', $item->id) }}"
                                                class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
                                            @if ($item->status == '1')
                                                <a href="{{ route('multiimage.show', $item->id) }}"
                                            ...
                                            @else
                                                <a href="{{ route('multiimage.show', $item->id) }}"
                                                    class="btn btn-success btn-sm"><i
                                                        ...
                                                        "></i></a>
                                            @endif
                                            <form action="{{ route('multiimage.destroy', $item->id) }}" method="post"
