...
@section('title', 'home about multi image')
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="text-dark fw-bold lead ">Home About Multi Image</h3>
                        ...
                        <form action="{{ route('multiimage.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="my-3">
                                <button class="btn btn-primary waves-effect waves-light" type="submit">Create Multi
                                    Image</button>
                            </div>
                        </form>
                    </div>
