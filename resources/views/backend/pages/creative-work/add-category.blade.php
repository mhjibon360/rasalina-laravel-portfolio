...
@section('title', 'add new portfolio category')
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class=" d-flex justify-content-between align-items-center">
                            <h3 class="text-dark fw-bold lead d-inline">Create New portfolio category</h3>
                            <a href="{{ route('portfoliocategory.index') }}" class=" btn btn-dark btn-sm">All portfolio Category</a>
                        </div>

                        <hr class=" text-info">
                        <form action="{{ route('portfoliocategory.store') }}" method="post" id="myForm">
                            @csrf
                            @method('post')
