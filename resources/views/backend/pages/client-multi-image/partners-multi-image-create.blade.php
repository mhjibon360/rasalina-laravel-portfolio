...
@section('title', 'partners multi image')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr class=" text-info">
                        <form action="{{ route('partners-multiimage.store') }}" method="post" enctype="multipart/form-data"
                            id="myForm">
                            @csrf
                            @method('post')
                            ...
                            <div class="my-3">
                                <button class="btn btn-primary waves-effect waves-light" type="submit">Create Partners Multi
                                    Image</button>
                            </div>
                        </form>
                    </div>
