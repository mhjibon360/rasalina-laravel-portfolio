...
@section('title', 'edit client multi image')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr class=" text-info">
                        <form action="{{ route('client-multiimage.update', $image->id) }}" method="post"
                            ...
                            <div class="my-3">
                                <button class="btn btn-primary waves-effect waves-light" type="submit">Update client
                                    Multi
                                    Image</button>
                            </div>
                        </form>
