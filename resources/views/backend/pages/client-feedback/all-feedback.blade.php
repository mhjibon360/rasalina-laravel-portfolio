...
@section('title', 'all client feedback list')
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="text-dark fw-bold lead ">All Client Feedback List</h3>
                            <<a href="{{ route('feedback.create') }}"
                                class="btn btn-dark fw-bold btn-sm waves-effect waves-light">
                                Add
                                New Client Feedback</a>
                        </div>
                        <hr class=" text-info">
                            ...
                            <tbody>
                                @foreach ($allfeedback as $item)
                                    <tr>
                                        ...
                                        <td style="width:20%">
                                            <a href="{{ route('feedback.edit', $item->id) }}" class="btn btn-info btn-sm"><i
